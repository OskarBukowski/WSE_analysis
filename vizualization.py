...
bilans = web_scrapping.ScrappingData(tkinter_input.Execute.user_tkinter_input,
                           wse_stocks_list_to_update.CheckInternalStockName().internal_name_scrapping()).main()['bilans_web']


rzis = web_scrapping.ScrappingData(tkinter_input.Execute.user_tkinter_input,
                           wse_stocks_list_to_update.CheckInternalStockName().internal_name_scrapping()).main()['rzis_web']

cash = web_scrapping.ScrappingData(tkinter_input.Execute.user_tkinter_input,
                           wse_stocks_list_to_update.CheckInternalStockName().internal_name_scrapping()).main()['cash_web']
