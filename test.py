...
#          label='Zadłużenie kapitału własnego')
# plt.plot(Path().source()['zadluzenia']['Zadłużenie ogólne'], color='C2', linestyle='-', linewidth=3,
#          label='Zadłużenie ogólne')
# plt.grid(axis='y', alpha=0.5)
# plt.xticks(xticks_zad, fontsize=13)
# plt.yticks(yticks, fontsize=14)
...
# plt.plot(Path().source()['rynkowej']['EV / Przychody ze sprzedaży'], color='r', linestyle='-', linewidth=3,
#          label='EV/REVENUE')
# plt.grid(axis='y', alpha=0.5)
#
# plt.xticks(xticks_ev, fontsize=12)
...
# plt.plot(Path().source()['rynkowej']['Cena / Przychody ze sprzedaży'], color='c', linestyle='-', linewidth=3,
#          label='P/REVENUE')
# plt.grid(axis='y', alpha=0.5)
#
# plt.xticks(xticks_ryn, fontsize=12)
...
porownanie_plot(data_preparation.Data.market_data_from_stooq(), 'KURS AKCJI', 'akcja_wolumen.JPG')




asset = data_preparation.Data.market_data_from_stooq()
